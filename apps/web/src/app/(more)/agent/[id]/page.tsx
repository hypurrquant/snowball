...
import { PermissionForm } from "@/domains/agent/components/PermissionForm";
...
export default function AgentProfilePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      {/* Permission Form - grant permission to this agent */}
      {address && agent && (
        <PermissionForm agentEndpoint={agent.endpoint} />
      )}
