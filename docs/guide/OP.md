...
### 2-4. frontend `.env` → `snowball/apps/web/.env`
...
# 수동 업데이트 필요
apps/web/src/config/addresses.json
```
...
3. Vite 재시작: `pkill -f vite && pnpm --filter @snowball/web dev`
