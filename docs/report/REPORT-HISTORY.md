...
| 2026-03-15 | [forked-protocols-and-licenses.md](./forked-protocols-and-licenses.md) | 포크/적용 프로토콜 라이선스 현황 정리 | GitHub API로 원본 저장소 LICENSE 파일 직접 조회 + 코드베이스 패키지 구조 분석 | 7개 프로토콜 원본/라이선스/적용수준/수정사항 총괄표 + 라이선스 리스크 평가 |
