...
export const AgentVaultABI = [
  ...
  { type: "function", name: "grantPermission", inputs: [{ name: "agent", type: "address" }, { name: "targets", type: "address[]" }, { name: "functions", type: "bytes4[]" }, { name: "cap", type: "uint256" }, { name: "expiry", type: "uint256" }], outputs: [], stateMutability: "nonpayable" },
  ...
  { type: "event", name: "PermissionGranted", inputs: [{ name: "user", type: "address", indexed: true }, { name: "agent", type: "address", indexed: true }, { name: "expiry", type: "uint256", indexed: false }] },
