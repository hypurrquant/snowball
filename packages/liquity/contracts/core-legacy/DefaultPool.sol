...
/// @title DefaultPool — Holds collateral and debt from redistributed troves
contract DefaultPool {
    ...
    /// @dev Called by TroveManager to record incoming collateral during redistribution.
    ///      The actual ERC20 transfer is done by ActivePool.sendColl() before this call.
    function increaseCollBalance(uint256 _amount) external onlyTroveManager {
        collBalance += _amount;
    }
