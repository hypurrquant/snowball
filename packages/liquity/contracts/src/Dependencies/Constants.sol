...
// Amount of CTC to be locked in gas pool on opening troves (Creditcoin adjusted)
uint256 constant ETH_GAS_COMPENSATION = 200 ether;
...
uint256 constant COLL_GAS_COMPENSATION_CAP = 2000 ether; // Max coll gas compensation capped at 2000 CTC

// Minimum amount of net sbUSD debt a trove must have (Creditcoin adjusted)
