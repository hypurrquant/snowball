...
// Amount of CTC to be locked in gas pool on opening troves (Creditcoin testnet — lowered for testing)
...
// Minimum amount of net sbUSD debt a trove must have (Creditcoin testnet — lowered for testing)
