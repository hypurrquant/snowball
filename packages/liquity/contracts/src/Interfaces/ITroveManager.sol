...
interface ITroveManager is ILiquityBase {
    ...
    //function sbUSDToken() external view returns (ISbUSDToken);
    ...
    function rewardSnapshots(uint256 _id) external view returns (uint256 coll, uint256 sbUSDDebt);
