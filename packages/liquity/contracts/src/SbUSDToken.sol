...
/*
 * --- Functionality added specific to the SbUSDToken ---
 *
...
contract SbUSDToken is Ownable, ISbUSDToken, ERC20Permit {
    ...
    function _requireValidRecipient(address _recipient) internal view {
        require(
            ...
            "SbUSDToken: Cannot transfer tokens directly to the Bold token contract or the zero address"
        );
    }
    ...
    function _requireCallerIsBOorAP() internal view {
        require(
            ...
            "SbUSDToken: Caller is not BO or AP"
        );
    }
    ...
    function _requireCallerIsCRorBOorTMorSP() internal view {
        require(
            ...
            "SbUSDToken: Caller is neither CR nor BorrowerOperations nor TroveManager nor StabilityPool"
        );
    }

    function _requireCallerIsStabilityPool() internal view {
        require(stabilityPoolAddresses[msg.sender], "SbUSDToken: Caller is not the StabilityPool");
    }
}
