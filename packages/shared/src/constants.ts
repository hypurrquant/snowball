...
export const STRATEGIES = {
  conservative: {
    name: "Conservative",
    minCR: 200,
    description: "CR > 200% — Maximum safety, lower capital efficiency",
  },
  moderate: {
    name: "Moderate",
    minCR: 160,
    description: "CR > 160% — Balanced risk/reward",
  },
  aggressive: {
    name: "Aggressive",
    minCR: 130,
    description: "CR > 130% — Higher capital efficiency, higher liquidation risk",
  },
} as const;
